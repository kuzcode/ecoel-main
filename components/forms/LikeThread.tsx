...
src={`/assets/heart-filled.svg`}alt='heart'width={22}height={22}className='cursor-pointer object-contain likeImg'
onClick={async()=>{
if (likes.includes(currentUserId)) {
setCount(count-1);
...
src='/assets/heart-gray.svg'alt='heart'width={22}height={22}className='cursor-pointer object-contain likeImg'onClick={async() => {
if(likes.includes(currentUserId)) {
setCount(count-1);
var index=likes.indexOf(currentUserId)
likes.splice(index)}
