...
return(<><Analytics/><SpeedInsights/><link rel="icon"href="../logo.png"sizes="32x32" /><h1 className='head-text text-left'>Главная</h1><p className='mt-3 text-base-regular text-light-2'>Любая мысль ✨</p>
