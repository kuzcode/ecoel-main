...
return(<main className='mx-auto bg-dark-1 flex max-w-3xl flex-col justify-start px-10 py-20'>
...
<section className='mt-9 bg-dark-2 p-10'><AccountProfile user={userData}btnTitle='Continue' /></section>
</main>);}
export default Page;